...
def start_script(request):
    ...
    export_results(story_events_df, "story events", "dbz_db_story_events", storage_client, bucket_name, prefix_path)  
    export_results(characters_df, "characters", "dbz_db_characters", storage_client, bucket_name, prefix_path)    
    end_time = time.time()
